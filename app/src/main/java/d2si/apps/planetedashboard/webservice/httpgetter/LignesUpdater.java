...
/**
 * class that represents lignes updater
 *
...
public abstract class LignesUpdater extends AsyncTask<Void, Void, ArrayList<Ligne>> {
    ...
    protected ArrayList<Ligne> doInBackground(Void... params) {
        try {
            ...
            final String url = AppUtils.formGetUrl(context.getString(R.string.REST_SERVER_URL), Integer.parseInt(context.getString(R.string.REST_SERVER_PORT)), context.getString(R.string.REST_REQUEST_LIGNES_UPDATE), new ArrayList<String>() {{
